...
This section presents the result of satellite image classification using three approaches: unsupervised classification and supervised classification by \hl{ML} methods using two approaches - "Decision tree classifier" and "Extra tree classifier". Figure \ref{fig05} shows the images generated using the clustering classification method, which illustrate the land cover changes with a bi-monthly time interval, Table \ref{tab01}.
