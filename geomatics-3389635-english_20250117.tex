...
\Author{\hl{Polina} Lemenkova $^{1,2}$\orcidA{}}
...
\address{%
$^{1}$ \quad \hl{Department of Biological, Geological and Environmental Sciences, Alma Mater Studiorum---Università di Bologna}, Via Irnerio 42, Emilia-Romagna, 40126 Bologna, Italy; \hl{polina.lemenkova2@unibo.it or polina.lemenkova@unibz.it}; Tel.: +39-3446928732

$^{2}$ \quad \hl{Faculty of Agricultural, Environmental and Food Sciences, Libera Università di Bolzano}, Piazza Università 5, \hl{Trentino-Alto Adige|S\"udtirol}, 39100, Bolzano, Italy
}
%MDPI:  affiliations: The address order should be from small to large. We have modified the address order. Please confirm.
%MDPI: Alma Mater Studiorum---Università di Bologna/Trentino-Alto Adige|S\"udtirol: Please confirm that the address format is correct
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{\hl{Workflow} diagram illustrating major steps of research design used for the organization of data processing tasks. Software: GIMP, version 2.10. Diagram source: author.}
    \label{fig04}
\end{figure}
...
%\bf{2019} &  &  &  &  &  &  & \\
\multicolumn{8}{c}{\textbf{\hl{2023: January}}}\\
\midrule
...
\midrule
%\bf{2022} &  &  &  & & & & \\
\multicolumn{8}{c }{\textbf{\hl{2023: March}}}\\
\midrule
...
%\bf{2023} &  &  &  & & & & \\
\multicolumn{8}{ c }{\textbf{\hl{2023: May}}}\\
\midrule
...
\end{equation}
\end{adjustwidth}
\hl{1: B}imonthly class separability matrices between 10 classes of land cover types in Rif Mountains, Morocco: January and March 2023 (1).
...
\end{equation}
\end{adjustwidth}
\hl{2: Bi}monthly class separability matrices between 10 classes of land cover types in Rif Mountains, Morocco: May and July 2023 (2).
...
\end{equation}
\end{adjustwidth}
\hl{3: Bimonthly} class separability matrices between 10 classes of land cover types in Rif Mountains, Morocco: September and November 2023 (3).
\vspace{12pt}
%MDPI:  1. We have modified the format of the formula, please confirm/2. Please confirm whether the nonindentation is maintained and whether need to be modified to normal indented paragraph. Same as the following text.
